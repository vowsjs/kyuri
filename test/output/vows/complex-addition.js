 ...
 * Step definitions for 'Complex Addition'
 *
...
Steps.GIVEN(/^GIVEN I have entered 50 into the calculator$/, function (topic) {
	...
	});// Step definitions for Scenario: Add three numbers
Steps.GIVEN(/^GIVEN I have entered <number1> into the calculator$/, function (topic) {
	  return function () {
	    // Always use or extend the same topic since you don't 
	    // know how nested or not nested you are at this point
	    topic = topic || {};
	...
	Steps.AND(/^AND I have entered <number2> into the calculator$/, function (topic) {
	  return function () {
	    // Always use or extend the same topic since you don't 
	    // know how nested or not nested you are at this point
	    topic = topic || {};
	...
	Steps.AND(/^AND I have entered 120 into the calculator$/, function (topic) {
	  return function () {
	    // Always use or extend the same topic since you don't 
	    // know how nested or not nested you are at this point
	    topic = topic || {};
	...
	Steps.THEN(/^THEN the result should be <number3> on the screen$/, function (topic) {
	  return function () {
	    /* Put your assert messages for this THEN here */
	  };
	});// Step definitions for Scenario: Add two numbers
